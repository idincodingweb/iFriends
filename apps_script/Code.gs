 ...
 *     /chats
 *
 * Each uploaded file is shared as "Anyone with the link → Viewer", so the
 * direct view URL can be embedded in the Flutter app.
 */

const ROOT_FOLDER = 'iFriends';
const ALLOWED_FOLDERS = ['profiles', 'posts', 'chats'];
